...
// (async () => {
//   try {
//     const inputTask = "make a smart contract that simulates a jail, people can get in and then someone can decide that someone can go out";
//     const { solidityCode, finalConclusion } = await generateSmartContract(inputTask);
//     console.log("Final Solidity Code:\n", solidityCode);
