...
const apiKey = ""; // API key de OpenAI eliminada
...
// Función para desplegar en AVAX
async function deployToAvax() {
  try {
...
`;
    ...
    const deployedAddress = await executeDeploymentCommand(
      "echo y| npx hardhat ignition deploy ./ignition/modules/generatedContract.js --network avax",
      __dirname
    );
    ...
    console.error("Error in deployToAvax function:", error);
    return null;
  }
}

// Función para desplegar en zkEVM
async function deployToZkEVM() {
  try {
    const contractPath = path.join(
      __dirname,
      "contracts",
...
`;
    ...
    const deployedAddress = await executeDeploymentCommand(
      "echo yes | npx hardhat ignition deploy ./ignition/modules/generatedContract.js --network zkEVM",
      __dirname
    );
    ...
    console.error("Error in deployToZkEVM function:", error);
    return null;
  }
}
...
`;
    ...
    const deployedAddress = await executeDeploymentCommand(
      "echo yes | npx hardhat ignition deploy ./ignition/modules/generatedContract.js --network scroll",
      __dirname
    );
    ...
    console.error("Error in deployToScroll function:", error);
    return null;
  }
}
...
// (async () => {
//   try {
//     const deployedAddress = await deployToAvax(); // O puedes probar deployToZkEVM();
